...
def review(json_path: str):
    ...
    if extraction.pico_elements:
        ...
        if action == 'v':
            ...
            pico.correction_metadata.last_reviewed = datetime.utcnow()
            pico.correction_metadata.reviewer_comment = click.prompt("Rejection reason (optional)", type=str, default="")
    ...
    for i, score in enumerate(extraction.quality_scores):
        ...
        if action == 'v':
            ...
            score.correction_metadata.last_reviewed = datetime.utcnow()
            score.correction_metadata.reviewer_comment = click.prompt("Rejection reason (optional)", type=str, default="")
    ...
    for i, claim in enumerate(extraction.claims):
        ...
        if action == 'v':
            ...
            claim.correction_metadata.last_reviewed = datetime.utcnow()
            claim.correction_metadata.reviewer_comment = click.prompt("Rejection reason (optional)", type=str, default="")
