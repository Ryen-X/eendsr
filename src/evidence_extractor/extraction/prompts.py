...
1.  **pico**: An object with keys "population", "intervention", "comparison", and "outcome". If an element is not found, its value should be null.
...
3.  **claims**: A JSON array of objects. Each object represents a key factual finding and must have a single key: "claim_text". Do not extract general statements or background info.
...
The caption is typically the text block directly below the figure, often starting with "Figure X:".
